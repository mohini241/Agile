...
$todo_name = "SELECT story_id,story_name,story_description,story_priority,story_category,story_outcome from user_story where story_status='ToDo' ";
...
$inprogress_name = "SELECT story_id,story_name,story_description,story_priority,story_category,story_outcome from user_story where story_status='InProgress' ";
...
$completed_name = "SELECT story_id,story_name,story_description,story_priority,story_category,story_outcome from user_story where story_status='Completed' ";
...
$accepted_name = "SELECT story_id,story_name,story_description,story_priority,story_category,story_outcome from user_story where story_status='Accepted' ";
...
';
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <p style="float:right; text-transform:capitalize; " id="sprint_display_todo"> </p>
            </h4>
            <br>
  ...
  <input type="text" class="form-control" name="story_outcome" value="'.$list_of_todo_outcome[$x].'">
    ...
    <input type="text" class="form-control" name="estimated_hours" placeholder="Enter estimated hours">
    </div>
    ...
    <option value="Accepted">Accepted</option>
          ...
          <button type="submit" class="btn btn-info btn-lg" name="update_story">Update</button>
          <button type="submit" class="btn btn-info btn-lg" name="add_task">Add task</button>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          </div>
        </div>
...
for ($x = 0; $x < $list_of_inprogress_count; $x++) {
   echo' <div class="card" style="width: 18rem;  border:none;">
  <img style="background-color: #ffffff;" src="in-progress.png" class="card-img-top" alt="...">
  <div class="card-body" style="padding:0rem !important;">
