...
if (isset($_POST['update_story_todo']))
{

    
    $SESSION['update_story_todo']=$_POST['update_story_todo'];

    //  var_dump(isset($SESSION['update_story_todo']));
}
...
if (isset($SESSION['update_story_todo'])) 
{ 
   
        $story_id = mysqli_real_escape_string($db, $_POST['todo_story_id']);
        $project_id = mysqli_real_escape_string($db, $_POST['project_id']);
        $username = mysqli_real_escape_string($db, $_POST['username']);
        $story_name = mysqli_real_escape_string($db, $_POST['todo_title']);
        $story_description = mysqli_real_escape_string($db, $_POST['todo_description']);
